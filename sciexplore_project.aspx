<%@ Page Language="VB" AutoEventWireup="false" CodeFile="sciexplore_project.aspx.vb" Inherits="sciexplore_project" %>
...
<body>
    <form id="form1" runat="server">
        <div id="content">
            ...
            <div id="center">
                <h1>
                    <asp:Literal ID="team_group" runat="server"></asp:Literal>
                </h1>
                <table border="1" style="width: 100%; margin-top: 20px; border-spacing: 5px; border-collapse: collapse;">
                    <tr>
                        <td style="width: 13%;">
                            <h2>隊名</h2>
                        </td>
                        <td style="width: 87%;">
                            <h2>
                                <asp:Literal ID="team_name" runat="server"></asp:Literal>
                            </h2>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <h2>
                                <asp:Literal ID="team_school" runat="server"></asp:Literal>：<asp:Literal ID="teammate" runat="server"></asp:Literal>
                            </h2>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <h2>
                                <asp:Literal ID="team_subject" runat="server"></asp:Literal>
                            </h2>
                        </td>
                    </tr>
                    <tr id="teacher_tr" runat="server">
                        <td>
                            <h2>指導老師</h2>
                        </td>
                        <td>
                            <h2>
                                <asp:Literal ID="team_teacher" runat="server"></asp:Literal>
                            </h2>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <h2 style="text-align: justify;">
                                <asp:Literal ID="team_abrust" runat="server"></asp:Literal>
                            </h2>
                        </td>
                    </tr>
                </table>
                <h1>作品成果</h1>
                <asp:Literal ID="pdf_box" runat="server"></asp:Literal>
                <!--<iframe src="project/1.pdf"></iframe>-->

                <div id="vote" runat="server">
                    <a id="vote_btn" runat="server" onserverclick="voting">投我一票</a>
                </div>
                <asp:Literal ID="Literal_btn" runat="server" Visible="false"></asp:Literal>
            </div>
            <div id="footer">
                <div id="fb-root"></div>
