    ...
    Sub vote_list()
        ...
        Try
            ...
            For group_count = 1 To 4  '--共有四個組別
                ...
                cmd = New MySqlCommand("select * from team where guid not in( select guid from teammate where teammate_gender = 'm' ) and team_leader_gender='f' and stage = '1' and activity_group = '" & group_count & "';", Conn)
