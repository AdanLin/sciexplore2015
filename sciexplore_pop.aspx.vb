    ...
    Sub vote_list()
        ...
        Try
            ...
            For group_count = 1 To 4  '--共有四個組別
                'cmd.Parameters.AddWithValue("g_count", group_count.ToString)
                Dim cmd As MySqlCommand = Nothing
                cmd = New MySqlCommand("select * from team where activity_group = '" & group_count & "' and stage = '1';", Conn)
                ...
                For i = 0 To AL.Count - 1
                    ...
                    '--取得票數
                    cmd2 = New MySqlCommand("SELECT COUNT(*) FROM pop_vote_count WHERE guid='" & CL(i) & "';", Conn2)
                    'cmd2.Parameters.AddWithValue("guid", CL(i).ToString)
