<%@ Page Title="管理帳戶" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Manage.aspx.vb" Inherits="Account_Manage" %>
            ...
            <section id="passwordForm">
                ...
                <asp:PlaceHolder runat="server" ID="changePasswordHolder" Visible="false">
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                            <div class="col-md-offset-2 col-md-10">
                                <asp:Button ID="Button2" runat="server" Text="變更密碼" OnClick="ChangePassword_Click" CssClass="btn btn-default" ValidationGroup="ChangePassword" />
                            </div>
                        </div>
                    </div>
                </asp:PlaceHolder>
                ...
                <asp:ListView ID="ListView1" runat="server"
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td>
                                <asp:Button ID="Button3" runat="server" Text="移除" CommandName="Delete" CausesValidation="false"
