<%@ Page Language="VB" AutoEventWireup="false" CodeFile="sciexplore_registration_last.aspx.vb" Inherits="sciexplore_registration_last" %>
...
<head runat="server">
    ...
    <title>2015全國科學探究競賽-這樣教我就懂：註冊成功</title>
...
<body>
    <form id="form1" runat="server">
        <div id="content">
            ...
            <div id="center">
                <asp:Literal ID="result_text" runat="server"></asp:Literal>
            </div>
            <div id="footer">
                <div id="fb-root"></div>
                <script>
