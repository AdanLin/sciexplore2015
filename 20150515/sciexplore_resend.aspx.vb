        ...
        Else
            ...
            If dr.HasRows() Then
                ...
                If dr.Item("auth").ToString = "0" Then
                    ...
                    MySmtp.Credentials = New System.Net.NetworkCredential("sciexplore2015@gmail.com", "scipower")
                    MySmtp.EnableSsl = True
                    MySmtp.Send(mail)
                    MySmtp.Dispose()
                    mail.Dispose()
                    '--show the complete message
                    Me.warn_message.Text = "<font color = ""#5873A3"">已將信件寄出，請至電子信箱查收並完成認證，謝謝。<br />(信件可能會被歸類至垃圾信件中)</font>"
                Else
                    '發送Email
                    'Dim mail_content As String = "<p>歡迎註冊2015全國科學探究競賽-這樣教我就懂網路票選系統</p><br /><p>" & dr.Item("user_name").ToString & "您好~</p><br />" & "<p>您的帳號為: " & dr.Item("email").ToString & "</p><br /><p>您的密碼為: " & dr.Item("pw").ToString & "</p><br />" _
                    ...
                    mail.Dispose()
                    '--show the complete message
                    Me.warn_message.Text = "<font color = ""#5873A3"">已將信件寄出，請至電子信箱查收，謝謝。<br />(信件可能會被歸類至垃圾信件中)</font>"
                End If
            Else
